  ...
  return (
    ...
    >
      ...
      <div class="max-w-4xl px-10 my-4 py-6 bg-white rounded-lg border-2 shadow-md">
        ...
        <div class="mt-2">
            <a class="text-2xl text-gray-700 font-bold hover:text-gray-600" >{blog.title}</a>
            
        </div>
        <div class="flex justify-between items-center mt-4">
            <a class="text-blue-600 hover:underline" ><button
            className="text-white px-4 w-auto h-10 bg-red-600 rounded-full "
