  ...
  return (
    <div className="flex flex-col w-full h-full bg-white max-w-full rounded-2xl px-10 py-8 mt-5 shadow-lg hover:shadow-2xl transition duration-500">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="">
          <button className="text-white px-4 w-auto h-10 bg-red-600 rounded-full hover:bg-red-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none" onClick={islike ? handleunlike : handlelike} >
            {likecomment}
            <svg
              viewBox="0 0 20 20"
