...
function CommentCard ({comment}) {
  ...
  return (
    ...
    <div  class="flex flex-col w-full h-full bg-white max-w-full rounded-2xl px-10 py-8 m-10 shadow-lg hover:shadow-2xl transition duration-500">
      
      
        <p class="mt-4 text-md text-gray-600">{comment.commentMessage}</p>
        <div class="flex justify-between items-center">
          <div class="mt-4 flex items-center space-x-4 py-6">
            
           
            <div class="text-sm font-semibold">{comment.owner.username} <span class="font-normal"> {comment.createDate.substring(0, 10)}</span></div>
          </div>
          <div class="">
